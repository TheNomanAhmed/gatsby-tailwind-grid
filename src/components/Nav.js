  ...
  return (
    <div className="w-full bg-white">
      ...
      >
        ...
        <section
          id="bottom-navigation"
          className="block fixed inset-x-0 bottom-0 z-10 bg-blue-200 shadow"
        >
          <div id="tabs" className="flex justify-between">
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M13.703 3.866a.446.446 0 00-.617 0L2.813 13.681a.446.446 0 00-.138.323v9.211a1.786 1.786 0 001.786 1.786h5.363a.893.893 0 00.893-.893v-7.589a.446.446 0 01.446-.446h4.464a.446.446 0 01.446.446v7.589a.893.893 0 00.893.893h5.36a1.786 1.786 0 001.786-1.786v-9.211a.446.446 0 00-.139-.323z" />
