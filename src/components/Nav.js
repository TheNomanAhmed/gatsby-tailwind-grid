  ...
  return (
    <div className="w-full bg-white">
      ...
      >
        ...
        <section
          id="bottom-navigation"
          className="block fixed inset-x-0 bottom-0 z-10 bg-background shadow"
        >
          <div
            id="tabs"
            className="flex justify-between border-t-2 border-gray-500"
          >
            <Link
              to="./grid"
              className="w-full focus:text-teal-500 group text-body hover:text-body justify-center inline-block text-center pt-2 pb-1"
            >
              <svg
                width="24.172"
                height="23"
                className="inline-block group mb-1 text-body"
                stroke-width="1.5"
                // fill="#ecd9ff"
              >
                <path
                  className="fill-navDark stroke-navDark group-hover:fill-navLight"
                  data-name="Path 1"
                ...
                />
                <path
                  className=" stroke-navDark group-hover:fill-navLight"
                  data-name="Path 3"
            ...
            >
              <svg
                ...
                height="25"
                viewBox="0 0 42 42"
                className="inline-block mb-1 text-body "
              >
                <g
                ...
                >
                  ...
                  <path
                    className="fill-navLight stroke-navLight group-hover:fill-navDark"
